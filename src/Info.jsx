                    ...
                    <div className='flex gap-20'>
                        <img className='img-about' src={Test} alt='test pic'/> 
                            <div className='flex-wrap'>
                                <h4 className='text-[50px] font-thin pt-24 overflow-hidden'>Shop!</h4>
                                <p className='text-about'>As of recent, Apple Crafts has expanded into a boutique located at 
                                    <p className='font-bold text-center text-[30px]'>Grounds for Dismissal</p> 
